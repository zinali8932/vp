...
<div id="challengeWindowWrapper">
    <div id="challengeWindow01">
        ...
        <div class="text">
            <span>Benytt BankID på mobil ved å oppgi mobilnummer og fødselsdato.</span>
        </div>
        <p class="text"></p>
													...
													<div class="bidm_wrapper">
														<div class="bidm_input-block">
															<div class="bidm_input-wrapper">
																<input id="bidm_phone" class="bidm_phone" type="tel" maxlength="8" placeholder="8 siffer" tabindex="2200" autocomplete="off" autocorrect="off" autocapitalize="off" aria-invalid="true" aria-required="true" required="" name="phone">
														...
														<div class="bidm_input-block">
															<div class="bidm_input-wrapper">
																<input id="bidm_birth" class="bidm_birth" type="tel" maxlength="6" placeholder="ddmmåå" tabindex="2500" autocomplete="off" autocorrect="off" autocapitalize="off" aria-invalid="true" aria-required="true" required="" name="dob">
